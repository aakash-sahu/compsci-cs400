...
You need to write a function called pairFactory that creates an instance of Pair on the heap. Do not create the object on the stack.
...
int main() {
  ...
  p->check();
  int x = 0;
  std::cout <<  &p << " space 2 "<< & x<< " space 3 " << p << " space 4 "  << std::endl;
